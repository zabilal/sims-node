...
import ErrorConverter from '../../../src/middlewares/error.js';
...
describe('Error middlewares', () => {
  describe('Error converter', () => {
    test('should return the same ApiError object it was called with', () => {
      ...
      ErrorConverter.errorConverter(error, httpMocks.createRequest(), httpMocks.createResponse, next);
  ...
  describe('Error handler', () => {
    ...
    test('should send proper error response and put the error message in res.locals', () => {
      ...
      ErrorConverter.errorHandler(error, httpMocks.createRequest(), res);
